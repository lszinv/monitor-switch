...
namespace MonitorSwitch {
  ...
  private:
    ...
    void QueryVcpFeature(HANDLE, BYTE, const char*) const;

    BOOL GetMonitorVCPValue(HMONITOR hMonitor, BYTE vcpCode, DWORD &currentValue, DWORD &maxValue) const;
